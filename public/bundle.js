    ...
    .map((item) => {
      return (
        `<li class="event__offer">
          <span class="event__offer-title">${Object(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["generateStatement"])(item[0])}</span>
          &plus;&euro;&nbsp;
...
const createCardListItemFormTemplate = (cardItem, options = {}) => {
  ...
  const addCardItemDate = moment__WEBPACK_IMPORTED_MODULE_2___default()(cardItemDate).format(`DD/MM/YY HH:mm`);
  const addSpendingTime = moment__WEBPACK_IMPORTED_MODULE_2___default()(spendingTime).format(`DD/MM/YY HH:mm`);
...
class CardListItemForm extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(cardItem) {
    ...
    this._activateExtraOptions = Object(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["getChangedValuesOfMap"])(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["EXTRA_OPTIONS"]);
  ...
  reset() {
    ...
    this._isChangeFavorite = !!cardItem.isFavorite;
    this._activateCheckedType = new Map(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["WAYBILL_TYPES"]).set(cardItem.waybillType, true);
    this._activateCheckedPurpose = new Map(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["WAYBILL_PURPOSE"]).set(cardItem.waybillPurpose, true);
    this._activateExtraOptions = Object(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["getChangedValuesOfMap"])(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["EXTRA_OPTIONS"]);
    this._cardItemDate = moment__WEBPACK_IMPORTED_MODULE_2___default()(cardItem.cardItemDate).format(`YYYY-MM-DD HH:mm`);
    this._spendingTime = moment__WEBPACK_IMPORTED_MODULE_2___default()(cardItem.spendingTime).format(`YYYY-MM-DD HH:mm`);
  ...
  _applyFlatpickr() {
    ...
    const cardItemDate = moment__WEBPACK_IMPORTED_MODULE_2___default()(this._cardItem.cardItemDate).format(`YYYY-MM-DD HH:mm`);
    const spendingTime = moment__WEBPACK_IMPORTED_MODULE_2___default()(this._cardItem.spendingTime).format(`YYYY-MM-DD HH:mm`);

    const eventStartTime = this.getElement().querySelector(`#event-start-time-1`);
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(eventStartTime, {
      altInput: false,
      allowInput: true,
      enableTime: true,
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(eventEndTime, {
      altInput: false,
      allowInput: true,
      enableTime: true,
      // eslint-disable-next-line camelcase
  ...
  _subscribeOnEvents() {
    ...
    eventTypeGroup.forEach((it) => {
      it.addEventListener(`change`, (evt) => {
        ...
        this._cardItem.extraOptions = new Map(Object(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["generateExclusiveArray"])(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["EXTRA_OPTIONS"], 0, 5));
        this.reRender();
      });
    });
    ...
    eventInputDestination.addEventListener(`change`, (evt) => {
      ...
      this._cardItem.description = new Set(Object(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["generateExclusiveArray"])(_formulas_js__WEBPACK_IMPORTED_MODULE_1__["WAYBILL_DESCRIPTION"], 1, 3));
      this.reRender();
    });
    ...
    eventStartTime.addEventListener(`change`, (evt) => {
      const newDate = moment__WEBPACK_IMPORTED_MODULE_2___default()(evt.target.value).format(`YYYY-MM-DD HH:mm`);
...
/*!*************************!*\
  !*** ./src/formulas.js ***!
  \*************************/
/*! exports provided: generateStatement, getRandomIntegerNumber, generateWaybillType, getRandomDateArray, renderComponent, createElement, castTimeFormat, remove, replace, dayCounter, itemTimePeriod, WAYBILL_TYPES, WAYBILL_PURPOSE, EXTRA_OPTIONS, getChangedValuesOfMap, WAYBILL_DESCRIPTION, generateExclusiveArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EXTRA_OPTIONS", function() { return EXTRA_OPTIONS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getChangedValuesOfMap", function() { return getChangedValuesOfMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WAYBILL_DESCRIPTION", function() { return WAYBILL_DESCRIPTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateExclusiveArray", function() { return generateExclusiveArray; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);


const generateStatement = (it) => {
  switch (it) {
    case `comfort`:
...
const getChangedValuesOfMap = (array) => {
...
const generateExclusiveArray = (array, minCount, maxCount) =>
...
/*!**************************!*\
  !*** ./src/mock/card.js ***!
  \**************************/
/*! exports provided: generateCardItem, generateSomeUnit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateCardItem", function() { return generateCardItem; });
...
const generateCardItem = () => {
  ...
  return {
    extraOptions: new Map(Object(_formulas_js__WEBPACK_IMPORTED_MODULE_0__["generateExclusiveArray"])(_formulas_js__WEBPACK_IMPORTED_MODULE_0__["EXTRA_OPTIONS"], 0, 5)),
    ...
    description: new Set(Object(_formulas_js__WEBPACK_IMPORTED_MODULE_0__["generateExclusiveArray"])(_formulas_js__WEBPACK_IMPORTED_MODULE_0__["WAYBILL_DESCRIPTION"], 1, 3)),
