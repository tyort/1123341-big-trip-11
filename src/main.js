...
const render = (elem, temp, where) => elem.insertAdjacentHTML(where, temp);

const tripSiteMain = document.querySelector(`.trip-main`);

const tripSiteInfo = tripSiteMain.querySelector(`.trip-main__trip-info`);
render(tripSiteInfo, createRouteSiteTemplate(), `afterBegin`);

const tripSiteControls = tripSiteMain.querySelector(`.trip-main__trip-controls`);
const tripSiteControlsHead = tripSiteControls.querySelector(`.visually-hidden`);
render(tripSiteControlsHead, createMenuSiteTemplate(), `afterEnd`);
render(tripSiteControls, createFilterSiteTemplate(), `beforeEnd`);

const tripSiteEvents = document.querySelector(`.trip-events`);
render(tripSiteEvents, createSortSiteTemplate(), `beforeEnd`);
render(tripSiteEvents, createContentSiteTemplate(), `beforeEnd`);
